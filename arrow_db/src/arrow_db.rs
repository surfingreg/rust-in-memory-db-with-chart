...
fn chart_zero_data() ->Result<Chart, KitchenSinkError> {

    tracing::debug!("[chart_zero_data]");

    // match serde_json::from_str::<Chart>(r#"[{"key" : "aapl", "val" : [10.5500, 6.5800]}]"#){
    ...
    //     },
    //     Err(e) => {
    //         tracing::debug!("[chart_zero_data] serde conversion error: {:?}", &e);
